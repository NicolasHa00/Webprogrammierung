	...
	<nav class="site-header sticky-top py-1">
		<div
			...
			<a class="lead py-2 d-md-inline-block"
				href="http://localhost/Fahrradverleih_MN_PHP/index.php">Fahrradverleih MN</a>
...
?>
	...
	<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3 largeMargin">
		<div class="snip1214">
			<div class="plan">
				...
				<div class="plan-cost">
					<span class="plan-price">2€</span><span class="plan-type">/
						Stunde</span>
				</div>
				<ul class="plan-features">
					<li><i class="ion-checkmark"> </i>Herren-, Damen- und
						Kinderfahrräder</li>
					<li><i class="ion-checkmark"> </i>Verleih an ausgewählten
						Standorten</li>
					<li><i class="ion-checkmark"> </i>Rückgabe an ausgewählten
						Standorten</li>
					<li><i class="ion-checkmark"> </i>Maximale Ausleihdauer: 24h</li>
					<li><i class="ion-checkmark"> </i>Standardversicherung</li>
					<li><i class="ion-checkmark"> </i>exkl. Zubehör</li>
				</ul>
			</div>
			<div class="plan">
				<h3 class="plan-title">Premium</h3>
				<div class="plan-cost">
					<span class="plan-price">4€</span><span class="plan-type">/
						Stunde</span>
				</div>
				<ul class="plan-features">
					<li><i class="ion-checkmark"> </i>Herren-, Damen-, Kinder- und
						Mountainbikefahrräder</li>
					<li><i class="ion-checkmark"> </i>Verleih an allen Standorten</li>
					<li><i class="ion-checkmark"> </i>Rückgabe an allen Standorten</li>
					<li><i class="ion-checkmark"> </i>Maximale Ausleihdauer: 72h</li>
					<li><i class="ion-checkmark"> </i>Premiumversicherung</li>
					<li><i class="ion-checkmark"> </i>inkl. Zubehör</li>
				</ul>
			</div>
			<div class="plan">
				<h3 class="plan-title">Spezial</h3>
				<div class="plan-cost">
					<span class="plan-price">6€</span><span class="plan-type">/
						Stunde</span>
				</div>
				<ul class="plan-features">
					<li><i class="ion-checkmark"> </i>Alle Fahrradtypen inkl.
						E-Bikes</li>
					<li><i class="ion-checkmark"> </i>Verleih an allen Standorten</li>
					<li><i class="ion-checkmark"> </i>Rückgabe an allen Standorten</li>
					<li><i class="ion-checkmark"> </i>Maximale Ausleihdauer:
						unbegrenzt</li>
					<li><i class="ion-checkmark"> </i>Spezialversicherung</li>
					<li><i class="ion-checkmark"> </i>inkl. Zubehör und
						kostenlosem Laden</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="textDiv">
		<p>Sämtliche Preise sind selbstverständlich inklusive 19% MwSt.
			und ohne zusätzliche Gebühr.</p>
		<p>Kontaktieren Sie uns gerne falls Sie Fragen zu den
			verschiedenen Preisoptionen haben. Kontaktinformationen finden Sie
			unter dem Tab "Kontakt".</p>
	</div>
