...
<body>
    ...
    function createImage()
    {
        ...
        imagestring($image, 5, 45, 15, $ausgabe . " Leihen Sie sich ihr Fahrrad schnell aus und beeilen sie sich besser, schon " . $stprozentverliehen . "% unserer Fahrraeder sind verliehen!", $text_color);
